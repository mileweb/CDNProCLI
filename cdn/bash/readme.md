...
3. For the property creation and update API calls, you can use the ```-e``` switch to pass the [Edge Logic](https://docs.google.com/a/quantil.com/document/d/e/2PACX-1vRBkWarteVbBD5vyy2h6X0fWyJtNpL0z6LOTViz-E39Gz33gVro3Z7koF9mDziAF4hzOQT3vCJswBy2/pub) file to the main script. The script will look for ```"serverScript" : _EDGE_LOGIC_``` in the json file and replace ```_EDGE_LOGIC_``` with the escaped Edge Logic code.
